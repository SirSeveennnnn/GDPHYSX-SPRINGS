...
void Particle::integrate(float deltaTime)
{
    ...
    resultingAcceleration += acceleration * (1 / inverseMass); //inverse mass is 1 / mass meaning 1/(1/mass)
...
void Particle::FirePistol()
{
    ...
    SetVelocity(glm::vec3(70, 0.f, -35.f));
...
void Particle::FireLaser()
{
    ...
    SetVelocity(glm::vec3(200, 0.f, -100.f));
    SetAcceleration(glm::vec3(0, 0, 0));
    ResetResultingAcceleration();
    SetInverseMass(0.1f);
    SetDamping(0.999f);
...
void Particle::FireBallistic(BallisticType type)
{
    switch (type)
    {
    case Pistol:
